    ...
    <ScreenLayout title="Status">
      <View className=" flex-row justify-center mt-7 mb-3">
        <Pressable className="mx-4" onPress={() => setTab("Leave")}>
          ...
          {tab === "Leave" && <View className="h-[2px] bg-lettergreen mt-1" />}
        </Pressable>
      ...
      <ScrollView className="px-4 flex-1 mb-6">
        {tab === "Leave" ? (
          <>
            {/* Current Leave */}
            {leaves.current.map((leave, index) => (
              ...
              >
                ...
                <View className="bg-gray-50 rounded-xl p-3">
                  ...
                  {/* Alter Warden */}
                  <Text className="text-gray-500 mb-2">Alter mess manager</Text>
                ...
                <View className="bg-gray-50 rounded-xl p-3">
                  ...
                  <View className="flex-row justify-between items-center">
                    <View style={{flex: 1, paddingRight: 8}}>
                      ...
                      <Text className="text-gray-800">{complaint.reason}</Text>
                    </View>
