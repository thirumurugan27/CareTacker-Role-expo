...
const ApplyLeaveForm: React.FC<Props> = ({navigation}) => {
  ...
  return (
    <ScreenLayout title="Leave apply" navigation={navigation}>
      {/* Body content only — header/keyboard handling is handled by ScreenLayout */}
      <View className="bg-white">
        ...
        <View className="flex-row items-end mt-4">
          ...
          <View className="h-[45px] w-[45px] justify-center items-center">
            <Image source={BioCalendar} className="w-7 h-7" resizeMode="contain"/>
          </View>
        </View>
